...
# #GRU Models
#python train.py --model_architecture gru --model_size_info 1 154 --dct_coefficient_count 10 --window_size_ms 40 --window_stride_ms 40 --learning_rate 0.005,0.001 --how_many_training_steps 10000,10000 --summaries_dir work/GRU/GRU1/retrain_logs --train_dir work/GRU/GRU1/training
python train.py --model_architecture gru --model_size_info 1 100 --dct_coefficient_count 10 --window_size_ms 40 --window_stride_ms 40 --learning_rate 0.005,0.001,0.00002 --how_many_training_steps 10000,10000,10000 --summaries_dir work/GRU/GRU0_0/retrain_logs --train_dir work/GRU/GRU0_0/training
...
#python test.py --model_architecture gru --model_size_info 1 154 --dct_coefficient_count 10 --window_size_ms 40 --window_stride_ms 40  --checkpoint work/GRU/GRU1/training/best/gru_9336.ckpt-22000
